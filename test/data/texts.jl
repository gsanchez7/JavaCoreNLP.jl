##Hitchhiker's Guide Chapter 8
hitchhikers_text = "The Hitchhiker’s Guide to the Galaxy is a wholly remarkable
book. It has been compiled and recompiled many times over many years and under
many different editorships. It contains contributions from countless numbers of
travellers and researchers."

##Obama inauguration
obama_text = "What the cynics fail to understand is that the ground has shifted
...
at a decent wage, care they can afford, a retirement that is dignified. Where the
answer is yes, we intend to move forward. Where the answer is no, programs will
end. And those of us who manage the public's dollars will be held to account - to
...
that a nation cannot prosper long when it favors only the prosperous. The success
of our economy has always depended not just on the size of our Gross Domestic
Product, but on the reach of our prosperity; on the ability to extend opportunity
to every willing heart - not out of charity, but because it is the surest route
to our common good."

##Google.com/finance
google_text = "Britain’s Monarch Airlines [MONA.UL] collapsed on Monday, stranding
more than 100,000 travelers abroad after it fell victim to intense competition
for flights to holiday destinations in Spain and Portugal. The failure of Monarch,
the largest British airline to go bust, will affect nearly 900,000 passengers in
total and prompted the country’s biggest peacetime repatriation effort."

#Of Mice and Men
##553 words
long_text = " A few miles south of Soledad, the Salinas River drops in close to
...
#106 words
medium_text = " A few miles south of Soledad, the Salinas River drops in close to
...
narrow pool. On one side of the river the golden foothill slopes curve up to the
...
#21 words
short_text = " A few miles south of Soledad, the Salinas River drops in close to
the hillside bank and runs deep and green."

#Sentiment texts
happy_text = "I was so glad to meet John today.  Whenever I see him I smile."
